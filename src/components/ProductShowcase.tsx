...
//       <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 bg-white rounded-lg shadow-lg p-6">
        
//         {/* Left Section: Playstation 5 */}
//         <div className="lg:col-span-2 col-span-1 flex flex-col space-y-8 bg-gray-50 p-6 rounded-lg hover:shadow-lg transition-shadow duration-300">
...
//             {/* Apple AirPods Max */}
//             <div className="flex items-center bg-slate-100 p-6 rounded-lg hover:bg-slate-200 transition duration-300 shadow-md">
//               <Image
...
//               />
//               <div className="ml-4">
//               <h3 className="text-xl font-bold">Apple AirPods Max</h3>
...
//               />
//               <div className="ml-4">
//                 <h3 className="text-xl font-bold">Apple Vision Pro</h3>
//                 <p className="text-gray-600">
...
//         <div className="lg:col-span-1 col-span-1 flex flex-col justify-center items-center bg-gray-100 p-6 rounded-lg hover:shadow-lg transition-shadow duration-300">
//           <div className="text-center">
//             <h2 className="text-4xl font-bold mb-4">
//               MacBook <span className="text-gray-600">Air</span>
//             </h2>
//             <p className="text-gray-600 mb-4">
//               The new 15-inch MacBook Air makes room for more of what you love with a spacious Liquid Retina display.
//             </p>
//             <button className="mt-4 bg-black text-white px-6 py-3 rounded-md hover:bg-gray-800 transition duration-300">
//               Shop Now
//               </button>
//           </div>
//           <Image
